...
All five skills exist: `init-project`, `add-task`, `implement-task`, `refine-backlog`,
`plan-feature` (`.claude/skills/`). Each pairs a `SKILL.md` checklist (judgment, interviews, STOP
