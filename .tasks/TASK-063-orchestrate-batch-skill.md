...
pr: null
merge_commit: null
blocked_by: [TASK-056, TASK-057, TASK-058, TASK-059, TASK-060, TASK-061, TASK-062]
blocks: []
---
...
Blocked on every other slice in this epic (TASK-056 through TASK-062) — this is the integration
task that wires them into one runnable loop.
...
5. On acceptance, proceed through `implement-task` phase 3 (open PR) as today — this epic does not
