...
| Task | Status | Title |
|---|---|---|
| TASK-001 | in-progress | Author guidelines.md and config.md for this repo |
...
| TASK-004 | todo | sync: stdlib frontmatter parser and artifact loader |
| TASK-005 | todo | sync: generated-region find / replace / append engine |
