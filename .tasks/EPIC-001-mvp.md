...
- Skills: `init-project`, `add-task`, `implement-task`, `refine-backlog`, `plan-feature`.
...
| TASK-003 | done | Add .github/pull_request_template.md mirroring acceptance criteria |
...
| TASK-023 | in-progress | Docs cleanup: remove redundant/deprecated info, relocate .tmp/ content, add README usage example |
